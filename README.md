...
You can **_soon_** download Marathon on Modrinth: [Download Marathon](https://modrinth.com/mod/marathon)
...
**Marathon** improves the vanilla toggle sprint mechanic by making it easy to toggle sprinting and sneaking with a
single key press. You also don't have to constantly have to re-toggle in some situations.